  ...
  const resources = [
    {
      ...
      title: 'Video Course',
      icon: '🎥',
      description: 'Watch comprehensive C++ programming tutorials',
      action: () => navigate('/programming-video-cpp'),
      color: 'blue'
    },
    {
      id: 'notes',
      title: 'Study Notes',
      icon: '📚',
      description: 'Access detailed C++ programming notes and documentation',
      action: () => window.open('https://www.geeksforgeeks.org/batch/skill-up-cpp?tab=Chapters', '_blank'),
      color: 'green'
    },
    {
      id: 'cheatsheet',
      title: 'Cheatsheet',
      icon: '📄',
      description: 'Quick reference guide for C++ programming',
      ...
      <header className="bg-gray-800 border-b border-gray-700">
        <div className="px-4 lg:px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">⚡ C++ Programming</h1>
      ...
      <div className="p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-700 rounded-2xl p-8 text-white text-center mb-8">
            <h1 className="text-3xl font-bold mb-4">⚡ C++ Programming Fundamentals</h1>
            <p className="text-blue-100 text-lg">Master C++ programming with in-depth tutorials and practical examples</p>
          </div>
