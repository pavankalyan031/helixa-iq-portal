...
const ProgrammingVideoPlayerCpp = () => {
  ...
  // Complete C++ Placement Course playlist: https://youtube.com/playlist?list=PLdo5W4Nhv31YU5Wx1dopka58teWP9aCee
  const cppVideos = [
  ...
  const progressPercentage = (watchedVideos.size / cppVideos.length) * 100
        ...
        <div className="px-4 lg:px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <button
                onClick={() => navigate('/cpp-programming')}
              ...
              <div>
                <h1 className="text-lg font-bold text-white">⚡ C++ Video Courses</h1>
      ...
      <div className={`h-[calc(100vh-80px)] ${isFullscreen ? 'flex flex-col' : 'flex'}`}>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="text-white">
                  <h3 className="text-lg font-semibold">
                    {cppVideos[currentVideoIndex]?.title || 'C++ Placement Course Tutorial'}
                  </h3>
                  <p className="text-gray-400 text-sm">
                    Duration: {cppVideos[currentVideoIndex]?.duration || 'N/A'}
                  </p>
                </div>
                <button
        ...
        <div className={`${isFullscreen ? 'w-full bg-gray-800 p-6' : 'w-1/2 bg-gray-800 border-l border-gray-700 p-6'} overflow-y-auto`}>
          ...
          <div className="mt-8 p-4 bg-gray-700/30 rounded-lg border border-gray-600">
            ...
            <p className="text-gray-400 text-xs">{watchedVideos.size} of {cppVideos.length} videos completed ({Math.round(progressPercentage)}%)</p>
          </div>
        </div>
      </div>
    </div>
...
export default ProgrammingVideoPlayerCpp