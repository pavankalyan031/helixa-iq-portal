      ...
      <header className="bg-gray-800 border-b border-gray-700">
        <div className="px-4 lg:px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">📦 Git & GitHub Video Course</h1>
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 h-full flex flex-col">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-400 text-sm mt-1">
                  Complete Git and GitHub course covering version control, branching, collaboration, and best practices
                </p>
              </div>
...
export default GitGitHubVideoPlayer