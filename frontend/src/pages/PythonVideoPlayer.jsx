  ...
  useEffect(() => {
    ...
    function createPlayer() {
      const newPlayer = new window.YT.Player(playerRef.current, {
        height: '100%',
        width: '100%',
        videoId: 'ERCMXc8x7mc', // Python video ID
        playerVars: {
          autoplay: 0,
          controls: 1,
          modestbranding: 1,
        ...
        events: {
          onReady: (event) => {
            console.log('Python video player ready')
      ...
      <header className="bg-gray-800 border-b border-gray-700">
        <div className="px-4 lg:px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">🐍 Python Video Course</h1>
...
export default PythonVideoPlayer