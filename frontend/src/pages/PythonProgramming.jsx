  ...
  const resources = [
    {
      ...
      title: 'Video Course',
      icon: '🎥',
      description: 'Watch comprehensive Python programming tutorials',
      action: () => navigate('/programming-video-python'),
      color: 'blue'
    },
    {
      id: 'notes',
      title: 'Study Notes',
      icon: '📚',
      description: 'Access detailed Python programming notes and documentation',
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <header className="bg-gray-800 border-b border-gray-700">
        <div className="px-4 lg:px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">🐍 Python Programming</h1>
      ...
      <div className="p-6">
        <div className="max-w-4xl mx-auto">
          {/* Welcome Section */}
          <div className="bg-gradient-to-r from-blue-600 to-green-700 rounded-2xl p-8 text-white text-center mb-8">
            <h1 className="text-3xl font-bold mb-4">🐍 Python Programming Fundamentals</h1>
            <p className="text-blue-100 text-lg">Learn Python programming with comprehensive tutorials, notes, and exercises</p>
          </div>
