      ...
      <header className="bg-gray-800 border-b border-gray-700">
        <div className="px-4 lg:px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">⚙️ DevOps Video Course</h1>
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 h-full flex flex-col">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-400 text-sm mt-1">
                  Complete DevOps course covering CI/CD, containerization, and modern development practices
                </p>
              </div>
                ...
                <div className="w-full max-w-3xl">
                  <div className="aspect-video bg-black rounded-lg overflow-hidden shadow-2xl">
                    <iframe
                      width="100%"
                      height="100%"
                      src="https://www.youtube.com/embed/saWZQr0RMpw"
                      title="Development and Operations Integration"
                      frameBorder="0"
...
export default DevOpsVideoPlayer