      ...
      <header className="bg-gray-800 border-b border-gray-700">
        <div className="px-4 lg:px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">Java Programming Practice</h1>
      ...
      <div className="p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-orange-600 to-red-700 rounded-2xl p-8 text-white text-center mb-8">
            <h1 className="text-3xl font-bold mb-4">☕ Java Programming</h1>
            <p className="text-orange-100 text-lg">Choose your learning resource to master Java</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-orange-500 transition-colors">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm mb-6">
                  Watch comprehensive Java programming tutorials with interactive learning.
                </p>
                <button
                  onClick={() => navigate('/java-video-player')}
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-blue-500 transition-colors">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm mb-6">
                  Detailed study materials and documentation for Java programming.
                </p>
                <a
                  href="https://www.geeksforgeeks.org/batch/skill-up-java?tab=Chapters"
                  target="_blank"
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-purple-500 transition-colors">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm mb-6">
                  Quick reference guides and shortcuts for Java programming.
                </p>
                <button
