...
// This file contains coding problems organized by topic and section
...
export const grindgramProblemsData = {
  ...
  array: {
    ...
    subtitle: 'This is a huge topic and an array acts as a base data structure for many concepts, so let\'s master the basics in this section.',
    sections: {
      ...
      'two-pointer': {
        ...
        sectionSubtitle: 'Similar to search, sort, this is also an important technique to learn.',
        xp: '0/55 XP',
        problems: [
  ...
  matrix: {
    ...
    subtitle: 'Matrix is super important for Advanced topics like graphs, DP, backtracking.',
    sections: {
  ...
  'sliding-window': {
    ...
    subtitle: 'Dont skip this topic, I personally have been asked this topic in many interviews.',
    sections: {
  ...
  'backtracking-recursion': {
    ...
    subtitle: 'This is super imp topic before moving further!! Draw the recursion tree to understand the flow',
    sections: {
  ...
  dp: {
    ...
    sections: {
      ...
      '2d-grid-dp': {
        sectionTitle: '2D Grid DP',
        sectionSubtitle: 'Two-dimensional grid dynamic programming problems.',
        xp: '0/225 XP',
        problems: [
          { title: 'Count paths - grid', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/count-possible-paths-top-left-bottom-right-nxm-grid/', practiceLink: 'https://www.geeksforgeeks.org/problems/grid-paths/1' },
          { title: 'Unique paths II', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/unique-paths-in-a-grid-with-obstacles/', practiceLink: 'https://www.geeksforgeeks.org/problems/unique-paths-in-a-grid/1' },
          { title: 'Minimum path sum in grid', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/min-cost-path-dp-6/', practiceLink: 'https://www.geeksforgeeks.org/problems/minimum-cost-path/1' },
          { title: 'Max path sum', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/find-maximum-path-sum-in-a-binary-tree/', practiceLink: 'https://www.geeksforgeeks.org/problems/maximum-path-sum/1' }
        ]
      }
    }
  },
  ...
  heaps: {
    ...
    subtitle: 'Heap data structure and its applications in problem solving.',
    sections: {
      'basic-patterns': {
        sectionTitle: 'Basic patterns',
        sectionSubtitle: 'Fundamental heap operations and implementations.',
        xp: '0/75 XP',
        problems: [
          { title: 'What is heap? Understand the data structure', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/heap-data-structure/', practiceLink: 'https://www.geeksforgeeks.org/problems/introduction-to-heap/1' },
          { title: 'Min heap implementation', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/min-heap-in-java/', practiceLink: 'https://www.geeksforgeeks.org/problems/min-heap/1' },
          { title: 'Max heap implementation', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/max-heap-in-java/', practiceLink: 'https://www.geeksforgeeks.org/problems/max-heap/1' },
          { title: 'Convert min heap to max heap', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/convert-min-heap-to-max-heap/', practiceLink: 'https://www.geeksforgeeks.org/problems/convert-min-heap-to-max-heap/1' }
        ]
      }
    }
  },
  ...
  trie: {
    ...
    subtitle: 'Trie data structure and its applications in string processing.',
    sections: {
      'basic-must-solve': {
        sectionTitle: 'Basic must solve',
        sectionSubtitle: 'Fundamental trie operations and important problems.',
        xp: '0/150 XP',
        problems: [
          { title: 'Implement trie', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/trie-insert-and-search/', practiceLink: 'https://www.geeksforgeeks.org/problems/trie-insert-and-search/1' },
          { title: 'Search suggestions system', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/search-suggestions-system-using-trie/', practiceLink: 'https://www.geeksforgeeks.org/problems/search-suggestions-system/1' },
          { title: 'Replace words', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/replace-words-using-trie/', practiceLink: 'https://www.geeksforgeeks.org/problems/replace-words/1' },
          { title: 'Design add and search words', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/add-and-search-word-data-structure-design/', practiceLink: 'https://www.geeksforgeeks.org/problems/add-and-search-word/1' },
          { title: 'Word search II', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/word-search-ii/', practiceLink: 'https://www.geeksforgeeks.org/problems/word-search-ii/1' },
          { title: 'Stream of characters', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/stream-of-characters/', practiceLink: 'https://www.geeksforgeeks.org/problems/stream-of-characters/1' }
        ]
      }
    }
  },
  ...
  string: {
    title: 'String',
    subtitle: 'Most of the imp problems in strings involves diff techniques, algos which are already covered.',
    sections: {
      'must-solve-algos-specific-to-string': {
        sectionTitle: 'Must solve and Algos specific to string',
        sectionSubtitle: 'String-specific important problems and algorithms.',
        xp: '0/360 XP',
        problems: [
          { title: 'Implement Atoi', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/write-your-own-atoi/', practiceLink: 'https://www.geeksforgeeks.org/problems/implement-atoi/1' },
          { title: 'Count and say', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/count-and-say/', practiceLink: 'https://www.geeksforgeeks.org/problems/count-and-say/1' },
          { title: 'Minimum bracket reversals', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/minimum-number-of-bracket-reversals-needed-to-make-an-expression-balanced/', practiceLink: 'https://www.geeksforgeeks.org/problems/minimum-bracket-reversals/1' },
          { title: 'Rabin karp algo', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/rabin-karp-algorithm-for-pattern-searching/', practiceLink: 'https://www.geeksforgeeks.org/problems/rabin-karp-algorithm-for-pattern-searching/1' },
          { title: 'KMP algo', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/kmp-algorithm-for-pattern-searching/', practiceLink: 'https://www.geeksforgeeks.org/problems/kmp-algorithm-for-pattern-searching/1' },
          { title: 'Longest happy prefix', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/longest-happy-prefix/', practiceLink: 'https://www.geeksforgeeks.org/problems/longest-happy-prefix/1' },
          { title: 'Remove all adjacent duplicates', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/remove-all-adjacent-duplicates-in-string/', practiceLink: 'https://www.geeksforgeeks.org/problems/remove-all-adjacent-duplicates-in-string/1' },
          { title: 'Hashing in strings', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/string-hashing-using-polynomial-rolling-hash-function/', practiceLink: 'https://www.geeksforgeeks.org/problems/string-hashing/1' },
          { title: 'Print all anagrams', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/given-a-sequence-of-words-print-all-anagrams-together/', practiceLink: 'https://www.geeksforgeeks.org/problems/print-all-anagrams-together/1' },
          { title: 'Z - Function', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/z-algorithm-linear-time-pattern-searching-algorithm/', practiceLink: 'https://www.geeksforgeeks.org/problems/z-function/1' },
          { title: 'Circle of strings', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/given-array-strings-find-strings-can-chained-form-circle/', practiceLink: 'https://www.geeksforgeeks.org/problems/circle-of-strings/1' },
          { title: 'Roman numerals to decimals', difficulty: 'medium', videoLink: 'https://youtu.be/example', solutionLink: 'https://www.geeksforgeeks.org/converting-roman-numerals-decimal-lying-1-3999/', practiceLink: 'https://www.geeksforgeeks.org/problems/roman-number-to-integer/1' }
        ]
      }
    }
  }
