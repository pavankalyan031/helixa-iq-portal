        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="flex items-center gap-4 mb-4 md:mb-0">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://github.com/ltsu-student-portal" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-700 rounded-full flex items-center justify-center hover:bg-gray-600 transition transform hover:scale-110" aria-label="GitHub">
                <img src="/assets/images/github.png" alt="GitHub" className="w-5 h-5 rounded-full"/>
              </a>
              <a href="https://www.linkedin.com/company/ltsu-student-portal" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-blue-700 rounded-full flex items-center justify-center hover:bg-blue-600 transition transform hover:scale-110" aria-label="LinkedIn">
